...
Aeroplane::Aeroplane(float x, float y, float z) {
    ...
    this->object1 = create3DObject(GL_TRIANGLES, 3*n, face1, COLOR_RED, GL_FILL);
    this->object2 = create3DObject(GL_TRIANGLES, 3*n, face2, COLOR_RED, GL_FILL);
    this->object3 = create3DObject(GL_TRIANGLES, 6*n, body, COLOR_BLACK, GL_FILL);
    ...
    this->object4 = create3DObject(GL_TRIANGLES, 3*n, face1, COLOR_RED, GL_FILL);
    this->object5 = create3DObject(GL_TRIANGLES, 3*n, face2, COLOR_RED, GL_FILL);
    this->object6 = create3DObject(GL_TRIANGLES, 6*n, body, COLOR_RED, GL_FILL);
    ...
    this->lwing = create3DObject(GL_TRIANGLES, 3, vertex_buffer_data, COLOR_RED, GL_FILL);
    ...
    this->rwing = create3DObject(GL_TRIANGLES, 3, vertex_buffer_data2, COLOR_RED, GL_FILL);
