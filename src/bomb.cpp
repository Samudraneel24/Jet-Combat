...
Bomb::Bomb(float x, float y, float z, float speed, float speedy, float rot_y) {
    ...
    this->speedz = speed*(cos(this->rot_y*(M_PI/180.0)));
    this->speedy = speedy;
...
void Bomb::draw(glm::mat4 VP) {
    ...
    // glm::mat4 rotate = glm::translate(glm::vec3(Bomb_x, Bomb_y, Bomb_z)) * rotatey * rotatex * rotatez * glm::translate(glm::vec3(-Bomb_x, -Bomb_y, -Bomb_z));
