...
Hill::Hill(float x, float z){
    ...
    this->Base = ThreeD(50, x, 0, z, this->BaseRadius, this->BaseRadius, 0.2, 90.0, COLOR_GREEN, COLOR_GREEN, COLOR_GREEN);
    this->Top = ThreeD(50, x, 0.0, z, this->TopTopRadius, this->TopBaseRadius, this->Height, 90.0, COLOR_GREEN, COLOR_GREEN, COLOR_GREEN);
}
